...
public class StreamsMapExample {
    ...
    private static Map<String, List<String>>  namesLengthMap(List<Student> names){

        Map<String, List<String>> namesLengthMap = names.stream()//Stream<String>
                .collect(toMap(Student::getName,Student::getActivities)); // returns Map
